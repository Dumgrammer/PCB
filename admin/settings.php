                            ...
                            <center>
                                ...
                                <tr>
                                  ...
                                  <tr>
                                        <td class="label-td" colspan="">
                                            <label for="Email" class="form-label">Email: </label>
                                            <input type="hidden" value="'.$aid.'" name="id00">
                                            <input type="hidden" name="oldemail" value="'.$aemail.'" >
                                        <input type="email" name="aemail" class="input-text" placeholder="Email Address" value="'.$aemail.'" required><br>
                                        </td>
                                   
                                    <td class="label-td" colspan="">
                                            <label for="aname" class="form-label">Name: </label>
                                            <input type="text" name="aname" class="input-text" placeholder="Nurse Name" value="'.$aname.'" required><br>
                                        </td>
                                        ...
                                        <td class="label-td" colspan="">
                                            ...
                                            <input type="password" name="apassword" class="input-text" placeholder="Defind a Password" required><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
